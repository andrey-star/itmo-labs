...
public class ArithmeticGV {
	...
	public String getGraph(ArithmeticParser.Node root) throws IOException {
	...
	private void traverse(ArithmeticParser.Node t, int pIndex, StringBuilder sb) {
		index++;
